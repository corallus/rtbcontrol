...
advs_adex_ref = {
    '3386': {'1': 19.650368000000004, 'all': 29.02608458227849, '2': 44.213328000000004, '3': 37.711368000000014},
    ...
    '2821': {'1': 61.942298684210535, 'all': 53.86468627810651, '2': 64.04917959183673, '4': 49.54528928571428,
             '3': 51.99172861445784},
...
# control parameters
advs_optimal_p = {"1458": 1500000, "2259": 100000, "2261": 500000, "2821": 40000, "2997": 1000000, "3358": 500000,
                  "3386": 50000, "3427": 500000, "3476": 500000}
advs_optimal_i = {"1458": 100, "2259": 20000, "2261": 5000, "2821": 200, "2997": 1000, "3358": 100, "3386": 10000,
                  "3427": 1000, "3476": 1000}
advs_optimal_d = {"1458": 10000, "2259": 10000, "2261": 50000, "2821": 100, "2997": 10000, "3358": 10000, "3386": 1000,
                  "3427": 1000, "3476": 10005}
advs_optimal_min_phi = {"1458": -3, "2259": -0.6, "2261": -0.8, "2821": -0.5, "2997": -0.5, "3358": -1, "3386": -0.45,
                        "3427": -1, "3476": -2}
advs_optimal_max_phi = {"1458": 5, "2259": 4, "2261": 5, "2821": 5, "2997": 5, "3358": 2, "3386": 2, "3427": 2,
                        "3476": 3}

# uni control parameters
advs_optimal_p_uni = {"1458": 1500000, "2259": 100000, "2261": 500000, "2821": 40000, "2997": 1000000, "3358": 500000,
                      "3386": 50000, "3427": 500000, "3476": 500000}
advs_optimal_i_uni = {"1458": 100, "2259": 20000, "2261": 5000, "2821": 200, "2997": 1000, "3358": 100, "3386": 10000,
                      "3427": 1000, "3476": 1000}
advs_optimal_d_uni = {"1458": 10000, "2259": 10000, "2261": 50000, "2821": 100, "2997": 10000, "3358": 10000,
                      "3386": 1000, "3427": 1000, "3476": 10005}
...
def control(para_p, para_i, para_d, outfile):
    ...
    zfo.write(
        "campaign\texchange\tlin.bid\tuni.bid\tctrl.bid\tlin.imp\tuni.imp\tctrl.imp\tlin.clk\tuni.clk\tctrl.clk\tlin.cost\tuni.cost\tctrl.cost\tuni.ref\tctrl.ref\n")
...
if mode == "single":  # single mode
    ...
    parameter_uni = "" + advertiser + "\t" + str(cntr_rounds) + "\t" + str(basebid) + "\t" + \
                    str(para_p_uni) + "\t" + str(para_i_uni) + "\t" + str(para_d_uni) + "\t" + str(
        settle_con) + "\t" + str(rise_con)
    rout.write(parameter_uni + "\t" + str(rise_time[0]["uni"]) + "\t" + str(settling_time[0]["uni"]) + "\t" + str(
        overshoot[0]["uni"]) + "\t" + \
